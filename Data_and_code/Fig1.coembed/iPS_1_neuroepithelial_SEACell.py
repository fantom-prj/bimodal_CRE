...
ad = sc.read('./scDART_n_SEACell/iPS_1_neuroepithelial/coembed.h5ad')
...
SEACells.plot.plot_initialization(ad, model, save_as="./scDART_n_SEACell/iPS_1_neuroepithelial/SEACells.initialization.png")
...
SEACell_ad.obs.to_csv("./scDART_n_SEACell/iPS_1_neuroepithelial/metadata.tsv", sep = "\t", index = False)
