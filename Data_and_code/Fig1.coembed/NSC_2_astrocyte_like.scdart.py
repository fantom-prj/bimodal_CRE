...
counts_rna = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/NSC_2_astrocyte_like/RNA.count.csv", index_col = 0)
counts_atac = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/NSC_2_astrocyte_like/ATAC.count.csv", index_col = 0)
label_rna = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/NSC_2_astrocyte_like/RNA.label.txt", header = None)
label_atac = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/NSC_2_astrocyte_like/ATAC.label.txt", header = None)
coarse_reg = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/NSC_2_astrocyte_like/region2gene.csv", sep = ",", index_col = 0).values
...
df.to_csv('/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/NSC_2_astrocyte_like/RNA.PCA.csv')
df1 = pd.DataFrame(z_atac_pca)
df1.to_csv('/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/NSC_2_astrocyte_like/ATAC.PCA.csv')
df2 = pd.DataFrame(z_rna)
df2.to_csv('/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/NSC_2_astrocyte_like/RNA.latent.csv')
df3 = pd.DataFrame(z_atac)
df3.to_csv('/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/NSC_2_astrocyte_like/ATAC.latent.csv')
