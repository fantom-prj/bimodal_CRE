...
counts_rna = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/iPS_0_undifferentiaed/RNA.count.csv", index_col = 0)
counts_atac = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/iPS_0_undifferentiaed/ATAC.count.csv", index_col = 0)
label_rna = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/iPS_0_undifferentiaed/RNA.label.txt", header = None)
label_atac = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/iPS_0_undifferentiaed/ATAC.label.txt", header = None)
coarse_reg = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/iPS_0_undifferentiaed/region2gene.csv", sep = ",", index_col = 0).values
...
df.to_csv('/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/iPS_0_undifferentiaed/RNA.PCA.csv')
df1 = pd.DataFrame(z_atac_pca)
df1.to_csv('/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/iPS_0_undifferentiaed/ATAC.PCA.csv')
df2 = pd.DataFrame(z_rna)
df2.to_csv('/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/iPS_0_undifferentiaed/RNA.latent.csv')
df3 = pd.DataFrame(z_atac)
df3.to_csv('/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/iPS_0_undifferentiaed/ATAC.latent.csv')
