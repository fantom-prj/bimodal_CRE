...
ad = sc.read('./scDART_n_SEACell/iPS_0_undifferentiaed/coembed.h5ad')
...
SEACells.plot.plot_initialization(ad, model, save_as="./scDART_n_SEACell/iPS_0_undifferentiaed/SEACells.initialization.png")
...
SEACell_ad.obs.to_csv("./scDART_n_SEACell/iPS_0_undifferentiaed/metadata.tsv", sep = "\t", index = False)
