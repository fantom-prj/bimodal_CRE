...
ad = sc.read('./scDART_n_SEACell/NSC_2_astrocyte_like/coembed.h5ad')
...
SEACells.plot.plot_initialization(ad, model, save_as="./scDART_n_SEACell/NSC_2_astrocyte_like/SEACells.initialization.png")
...
SEACell_ad.obs.to_csv("./scDART_n_SEACell/NSC_2_astrocyte_like/metadata.tsv", sep = "\t", index = False)
