...
counts_rna = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/neuron_mature2/RNA.count.csv", index_col = 0)
counts_atac = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/neuron_mature2/ATAC.count.csv", index_col = 0)
label_rna = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/neuron_mature2/RNA.label.txt", header = None)
label_atac = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/neuron_mature2/ATAC.label.txt", header = None)
coarse_reg = pd.read_csv("/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/neuron_mature2/region2gene.csv", sep = ",", index_col = 0).values
...
df.to_csv('/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/neuron_mature2/RNA.PCA.csv')
df1 = pd.DataFrame(z_atac_pca)
df1.to_csv('/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/neuron_mature2/ATAC.PCA.csv')
df2 = pd.DataFrame(z_rna)
df2.to_csv('/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/neuron_mature2/RNA.latent.csv')
df3 = pd.DataFrame(z_atac)
df3.to_csv('/analysisdata/fantom6/Interactome/single_cell_wallace/scDART/neuron_mature2/ATAC.latent.csv')
