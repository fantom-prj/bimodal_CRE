...
ad = sc.read('./scDART_n_SEACell/neuron_immature/coembed.h5ad')
...
SEACells.plot.plot_initialization(ad, model, save_as="./scDART_n_SEACell/neuron_immature/SEACells.initialization.png")
...
SEACell_ad.obs.to_csv("./scDART_n_SEACell/neuron_immature/metadata.tsv", sep = "\t", index = False)
